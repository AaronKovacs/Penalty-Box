...
- (void)showInContainerViewAnimated:(BOOL)animated
{
    ...
    // Present sheet
    if (animated)
        [UIView animateWithDuration:duration delay:0 usingSpringWithDamping:0.95 initialSpringVelocity:0 options:(UIViewAnimationOptionCurveEaseInOut | UIViewAnimationOptionAllowUserInteraction) animations:animations completion:nil];
